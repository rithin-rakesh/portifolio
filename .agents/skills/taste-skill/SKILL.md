---
name: taste-skill
description: Anti-slop frontend design framework and taste skill (taste-skill / design-taste-frontend) for landing pages, portfolios, marketing sites, and redesigns. Reads the brief, infers design language, tunes three dials (VARIANCE, MOTION, DENSITY), eliminates AI design clichés, maps to real design systems, and enforces strict pre-flight checks.
---
